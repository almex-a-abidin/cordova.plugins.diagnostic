            ...
            if (c != null) {
                ...
                if (pm != null) {
                    ...
                    if (mStartActivity != null) {
                        ...
                        PendingIntent mPendingIntent = (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) ? PendingIntent.getActivity(c, mPendingIntentId, mStartActivity, PendingIntent.FLAG_MUTABLE) : PendingIntent.getActivity(c, mPendingIntentId, mStartActivity,PendingIntent.FLAG_CANCEL_CURRENT);
