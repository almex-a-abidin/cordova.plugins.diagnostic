            ...
            if (c != null) {
                ...
                if (pm != null) {
                    ...
                    if (mStartActivity != null) {
                        ...
                        PendingIntent mPendingIntent = (Build.VERSION.SDK_INT > 30) ? PendingIntent.getActivity(c, mPendingIntentId, mStartActivity, PendingIntent.FLAG_IMMUTABLE) : PendingIntent.getActivity(c, mPendingIntentId, mStartActivity,PendingIntent.FLAG_CANCEL_CURRENT);
